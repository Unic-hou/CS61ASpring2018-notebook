...
def couple(lst1, lst2):
    ...
    "*** YOUR CODE HERE ***"
    length = [[] for _ in range(len(lst1))]
    for i in range(len(lst1)):
        length[i].append(lst1[i])
        length[i].append(lst2[i])
    return length
...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    x1, x2 = get_lon(city1), get_lon(city2)
    y1, y2 = get_lat(city1), get_lat(city2)
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    city = make_city('close', lat, lon)
    a = distance(city, city1)
    b = distance(city, city2)
    if a < b:
